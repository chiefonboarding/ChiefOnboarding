...
export default defineConfig({
  ...
  themeConfig: {
    ...
    editLink: {
      pattern:
          'https://github.com/chiefonboarding/chiefonboarding/edit/master/docs/:path'
    },
    nav: [
      {text: 'Home', link: '/'},
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          {
            text: 'Object storage (up/downloading files)',
            link: 'config/objectstorage'
          },
      ...
      {text: 'Development', link: 'development'}, {text: 'API', link: 'api'}, {
        ...
        items: [
          {text: 'Introduction', link: 'integrations/intro'}, {
            ...
            items: [
              ...
              {
                text: 'Initial data form',
                link: 'integrations/initial-data-form'
              },
              {
                text: 'Post execute notification',
                link: 'integrations/post-execution-notification'
              },
          ...
          },
          {
            ...
            items: [
              ...
              {text: 'Schedule', link: 'integrations/schedule'},
              {
                ...
                link: 'integrations/paginated-response'
              },
            ]
          }
        ]
