...
urlpatterns = [
    ...
    path('personal/language/', views.PersonalLanguageUpdateView.as_view(), name="personal-language"),
    ...
    path('integrations/google_login', views.GoogleLoginSetupView.as_view(), name="google-login"),
    path('integrations/google_account', views.GoogleAccountCreationSetupView.as_view(), name="google-account"),
    path('integrations/slack_account', views.SlackAccountCreationSetupView.as_view(), name="slack-account"),
    path('integrations/slack_bot', views.SlackBotSetupView.as_view(), name="slack-bot"),
    path('integrations/<int:pk>', views.IntegrationDeleteView.as_view(), name="delete-integration"),
